           ...
           <div class="card-body">
                <div class="col-md-3">
                        <div class="form-group row">
                                <label for="capacity" class="col-form-label text-md-right">Capacity:<span style="color:red">&nbsp*</span></label>
                                <div class="col-md-6">
                                    <input name="capacity" id="capacity" type="number" min="1" class="form-control" value="" required>
                                </div>     
                            </div>
                </div>
           </div>
